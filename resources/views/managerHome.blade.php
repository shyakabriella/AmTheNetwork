    ...
    <div class="title-info">
     ...
     <div class="data-info">
        ...
        <div class="box">
            ...
            <div class="data">
                <Currenp>Current Temperature</Currenp>
                <span>31°C</span> <!-- Example reading; this should be dynamic -->
            </div>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
     ...
     <div class="row">
        <div class="col-md-6">
            <canvas id="activityChart" style="width:100%; height:350px;"></canvas>
        </div>
        <div class="col-md-6">
        <canvas id="activityChart_line" style="width:100%; height:350px;"></canvas>
        </div>
     </div>
     <div >
    ...
    $(document).ready(function() {
        $('#searchForm').submit(function(e) {
            ...
            $.ajax({
                ...
                type: "GET",
                data: formData,    var myChart = new Chart(ctx, {
        type: 'line', // Change this from 'bar' to 'line'
        data: {
            labels: ['Week 1', 'Week 2', 'Week 3', 'Week 4'], // Placeholder labels
            datasets: [{
                label: 'Weekly Maximum Temperature',
                data: [12, 19, 3, 5], // Placeholder data
                backgroundColor: 'rgba(75, 192, 192, 0.2)', // Single color for background
                borderColor: 'rgba(75, 192, 192, 1)', // Single color for border
                borderWidth: 1,
...
<script>
    ...
    var ctx = document.getElementById('activityChart_line').getContext('2d');
    var myChart = new Chart(ctx, {
        type: 'line', // Change this from 'bar' to 'line'
        data: {
            labels: ['1', '2', '3', '4','5', '6', '7', '8'], // Placeholder labels
            datasets: [{
                label: 'Today Temperature information',
                data: [12, 19, 3, 5,11, 10, 13, 51], // Placeholder data
                backgroundColor: 'rgba(75, 192, 192, 0.2)', // Single color for background
                borderColor: 'rgba(75, 192, 192, 1)', // Single color for border
                borderWidth: 1,
                fill: false // Ensure the area under the line is not filled
